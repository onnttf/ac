...
CREATE TABLE `casbin_rule` (
  ...
  `v0` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '' COMMENT 'v0',
  `v1` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '' COMMENT 'v1',
  `v2` varchar(255) NOT NULL DEFAULT '' COMMENT 'v2',
  `v3` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '' COMMENT 'v3',
  `v4` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '' COMMENT 'v4',
  `v5` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '' COMMENT 'v5',
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_ptype_v0_v1_v2` (`ptype`,`v0`,`v1`,`v2`) USING BTREE
...
CREATE TABLE `casbin_rule_log` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_ptype_v0_v1_v2` (`ptype`,`v0`,`v1`,`v2`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
